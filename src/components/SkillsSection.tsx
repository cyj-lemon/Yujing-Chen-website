...
const skillCards = [
  {
    ...
    skills: [
      ...
      {
        text: '熟练使用前沿 AI 编程助手 (Kimi Code, Trae, Cursor 等) 实现高效开发与落地',
        highlight: '（注：本网站即为使用 Web Coding 工具由0到1独立生成的落地实践）',
      },
    ],
  },
  {
    ...
    skills: [
      '深度掌握 ChatGPT/Claude 高级用法，擅长复杂 Prompt 编写、逻辑重构与自动化工作流设计。',
      '熟练使用图像生成工具 (Nano Banana, Midjourney, Stable Diffusion 等) 辅助视觉表达。',
  ...
  },
  {
    ...
    skills: [
      ...
      '擅长从用户痛点出发，结合心理学洞察与 AI 技术能力，完成场景化产品创新与商业闭环。',
    ],
  },
];
              ...
              >
                ...
                <ul className="space-y-3">
                  {card.skills.map((skill, index) => {
                    // 判断是否为带高亮的技能项
                    if (typeof skill === 'object' && 'highlight' in skill) {
                      return (
                        <li
                          key={index}
                        ...
                        >
                          ...
                          <span>
                            {skill.text}
                            <em className="text-rose-500 text-xs ml-1 not-italic">
                              {skill.highlight}
                            </em>
                          </span>
                        </li>
